#!/usr/bin/env python3
"""
Main entry point for running the Teleavatar v2 robot with an OpenPI policy
using end-effector representation.
...
Usage:
    ...
    uv run scripts/serve_policy.py policy:checkpoint \
        --policy.config=pi05_teleavatar_v2_endeffector \
        --policy.dir=checkpoints/pi05_teleavatar_v2_endeffector/my_experiment/20000

    # Then run this script:
    python examples/teleavatar_v2/main_endeffector.py --remote-host 127.0.0.1
"""
...
from examples.teleavatar_v2 import env_endeffector as _env
